      ...
      <div class="card">
        <div class="card-header">
          <p><b>Tarjeta cliente fiel</b>, recibirás 5%, 10% y hasta el 50% de descuento al acumular compras.
            Y Además después de inscribirte, podrás ganar hasta el 5% de descuento solo con recomendarnos en <b>“pasa la voz waffcake”</b> cada vez que refieras a un amigo y el haga efectiva una compra, tu recibirás el 5% y tu referido el 2%</p>
          ...
          <form method="POST" action="{{ route('register') }}">
            ...
            <div class="col-12">
              <div class="custom-control custom-checkbox">
                ...
                <label class="custom-control-label" for="customCheck1"> He leído y acepto términos y condiciones – <a href="{{route('terminos_condicones')}}" target="_blank"> Ver aquí </a> </label>
              </div>
            </div>
            <hr>
