...
<div id="main-wrapper"> @include('layouts.base.nav')
  ...
  <footer class="footer"> © <script>document.write(new Date().getFullYear());</script> WaffCake - La wafflería del sabor / by <a data-toggle="tooltip" data-placement="top" href="https://www.geostigmamedia.com" title="Diseño y Desarrollo Web: Geostigma Media" target="_blank"><img src="https://www.waffcake.com/img/geostigma-media.png" alt="geostigmamedia"/></a></footer>
</div>
