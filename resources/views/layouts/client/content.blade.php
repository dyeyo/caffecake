<div class="welcome">
  <div class="row align-items-center">
    <div class="col-md-3"><img class="img-fluid" src="{{ asset('img/welcome.jpg') }}" alt="bienvenido a waffcake"></div>
    <div class="col-md-9">
      ...
      <div class="col-md-8">
        <div class="card-body">
          ...
          <p class="card-text">Acumula descuentos por tus compras. Obtienes el 5% a la
            ...
            acumular tus descuentos. Actívala con la primera compra.</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="card">
      <div class="card-body"> @if(Session::has('encuestaOk'))
        ...
        <p>De 1 a 5, como calificas el programa de beneficios waffcake, siendo 1 muy malo y 5 muy
          BUENO <b> ¿Qué le adicionarías?</b></p>
